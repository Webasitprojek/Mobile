...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText txtemail, txtusername, txtalamat, txtnohp, txtdate, txtpassword, confimpas;
...
//        confimpas = findViewById(R.id.confimpas);
        ...
        button_regis.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                User user = new User(username, alamat, email, gender, password, nohp, tglahir);
                    ...
                    })
                    {
                        ...
                        public byte[] getBody() {
                            try {
                                ...
                                jsonBody.put("tgl_lahir", tglahir);
